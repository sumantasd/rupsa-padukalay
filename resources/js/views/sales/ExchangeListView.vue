<template>
  <div class="space-y-6 antialiased font-sans max-w-7xl mx-auto pb-16">
      ...
      <div class="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-4xl w-full p-6 sm:p-8 space-y-6 max-h-[90vh] overflow-y-auto text-xs">
          ...
          <div class="space-y-1.5">
            ...
            <div class="flex gap-2">
              ...
              <button
                ...
                class="px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold shrink-0 shadow-sm"
              >
        ...
        <div v-else-if="wizardStep === 2" class="space-y-5">
          <div class="p-4 bg-slate-50 rounded-2xl border border-slate-200 flex justify-between items-center text-xs">
            ...
            <button @click="wizardStep = 1" class="px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs font-bold text-slate-700 hover:text-red-600">
              ← Change Bill
            </button>
          </div>
          ...
          <div class="flex items-center justify-between pt-3 border-t border-slate-200">
            ...
            <button
              ...
              class="px-6 py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl shadow-xs disabled:opacity-30"
            >
        ...
        <div v-else-if="wizardStep === 3" class="space-y-5">
          <div class="space-y-1.5">
            ...
            <div class="flex gap-2">
              ...
              <button
                ...
                class="px-5 py-2.5 bg-slate-900 text-white font-bold rounded-xl shrink-0"
              >
          ...
          <div v-if="exchangeReplacementItems.length > 0" class="space-y-2 pt-2 border-t border-slate-200">
            ...
            >
              ...
              <div class="flex items-center gap-3">
                ...
                <button @click="exchangeReplacementItems.splice(idx, 1)" class="p-1 text-red-600 hover:text-red-800 font-black text-sm">✕</button>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between pt-3 border-t border-slate-200">
            <button @click="wizardStep = 2" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl">← Back</button>
            <button
              @click="wizardStep = 4"
        ...
        <div v-else-if="wizardStep === 4" class="space-y-6">
          ...
          <div class="flex items-center justify-between pt-4 border-t border-slate-200">
            <button @click="wizardStep = 3" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl">← Back</button>
            <button
              @click="submitExchange"
              :disabled="submittingExchange"
              class="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-black rounded-xl shadow-md shadow-red-600/20 transition-all uppercase tracking-wider text-xs"
            >
    ...
    <div v-if="receiptExchange" class="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div class="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-sm w-full p-6 space-y-4">
        ...
        <div class="flex items-center justify-between border-b border-slate-200 pb-3">
          ...
          <button @click="receiptExchange = null" class="text-slate-400 hover:text-slate-800 font-bold">✕</button>
        </div>
        ...
        <div class="flex justify-end gap-2 pt-2 border-t border-slate-200">
          <button @click="receiptExchange = null" class="px-4 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold text-xs">
            Close
          </button>
    ...
    <div v-if="selectedExchange" class="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
      <div class="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-3xl w-full p-6 sm:p-8 space-y-6 max-h-[90vh] overflow-y-auto text-xs">
        <div class="flex items-center justify-between border-b border-slate-200 pb-4">
          ...
          <button @click="selectedExchange = null" class="p-2 rounded-xl text-slate-400 hover:text-slate-800 font-black text-lg">✕</button>
        </div>
        ...
        <div class="flex justify-end gap-2 pt-4 border-t border-slate-200">
          <button
            ...
            class="px-4 py-2 bg-red-600 text-white hover:bg-red-700 rounded-xl font-bold"
          >
            🧾 Print Receipt
          </button>
          <button @click="selectedExchange = null" class="px-5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold">
            Close
          </button>
        </div>
      </div>
